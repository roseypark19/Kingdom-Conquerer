class RangedMinion {
    ...
    loadAnimations() {
        ...
        this.animations.push(new AnimationGroup(this.spritesheet, 128 * 32, 0, 32, 32, 12, 0.15, false, true));
    };
    ...
    loadAnimations() {
        if (!(MinionProjectile.rotationList[this.projectileType][this.degrees])) {
            MinionProjectile.rotationList[this.projectileType][this.degrees] = 
                rotateImage(this.spritesheet, 32, 0, 32, 32, this.degrees * Math.PI / 180);
        }
        this.animation = 
