...
class Minimap {
    ...
    draw(ctx) {
        ...
        this.game.entities.forEach(entity => {
            ...
            if (entity.drawMmap && 
                (Math.abs(this.game.camera.hero.BB.center.x - entity.BB.center.x) <= PARAMS.CANVAS_DIMENSION * 0.75 &&
                 Math.abs(this.game.camera.hero.BB.center.y - entity.BB.center.y) <= PARAMS.CANVAS_DIMENSION * 0.75)) {
